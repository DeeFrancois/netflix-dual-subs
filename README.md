...
<sup> Upcoming Update: **v1.8.0** Resize text instead of going offscreen, subs no longer prevents clicking the seekbar, subs are no longer annoyingly close to seekbar, and some other bug fixes</sup>
